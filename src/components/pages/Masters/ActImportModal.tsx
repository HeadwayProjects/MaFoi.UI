...
import { useImportActs } from "../../../backend/masters";
...
function ActImportModal({ onSubmit, onClose }: any) {
    const [apiError, setApiError] = useState<any>(null)

    const { importActs, uploading } = useImportActs((response: any) => {
        ...
        fields: [
            {
                ...
                description: <a href="/" onClick={downloadSample}>Dowload Sample Acts</a>
            },
        ],
    };
    ...
    function downloadSample(e: any) {
        preventDefault(e);
        download('Sample Acts.xlsx', 'https://mafoi.s3.ap-south-1.amazonaws.com/bulkuploadtemplates/ActsTemplate.xlsx')
    }
        ...
        <>
            <Modal show={true} backdrop="static" animation={false} size="lg" dialogClassName="" centered={true}>
                <Modal.Header closeButton={true} onHide={onClose}>
                    <Modal.Title className="bg">Import Acts</Modal.Title>
                </Modal.Header>
                <Modal.Body>
