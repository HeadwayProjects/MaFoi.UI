...
import { useImportLocations } from "../../../../backend/masters";
...
function CompanyLocationsImportModal({ company, associateCompany, onSubmit, onClose }) {
    const [apiError, setApiError] = useState(null)

    const { importLocations, uploading } = useImportLocations((response) => {
    ...
    const schema = {
        fields: [
            ...
            },
            {
                ...
                description: <a href="/" onClick={downloadSample}>Dowload Sample Locations</a>
            },
        ],
    };
        ...
        <>
            <Modal show={true} backdrop="static" animation={false} size="lg" dialogClassName="" centered={true}>
                <Modal.Header closeButton={true} onHide={onClose}>
                    <Modal.Title className="bg">Import Company Locations</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
export default CompanyLocationsImportModal;