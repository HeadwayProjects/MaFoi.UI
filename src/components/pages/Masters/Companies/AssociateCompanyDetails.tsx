...
function AssociateCompanyDetails({ action, parentCompany, data, onClose }: any) {
    const [t] = useState(new Date().getTime());
    const [associateCompany, setAssociateCompany] = useState<any>({ hideButtons: true });
        ...
        fields: [
            ...
            },
            {
                ...
                condition: {
                    when: 'smtp',
                    is: () => {
                        const { smtp }: any = associateCompany
