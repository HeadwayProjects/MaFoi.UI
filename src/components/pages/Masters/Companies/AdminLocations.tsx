...
function AdminLocations({ onChange }: any) {
    ...
    return (
        <>
            <div className="px-2">
                ...
                <Select placeholder='Company' options={(parentCompanies || []).map((x: any) => {
            ...
            <div className="px-2">
                ...
                <Select placeholder='Associate Company' options={(associateCompanies || []).map((x: any) => {
                    return { value: x.id, label: x.name }
            ...
            <div className="px-2">
                ...
                <Select placeholder='Location' options={(locations || []).map((x: any) => {
