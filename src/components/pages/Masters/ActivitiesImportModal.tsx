...
import { useImportActivities } from "../../../backend/masters";
...
function ActivitiesImportModal({ onSubmit, onClose }: any) {
    const [apiError, setApiError] = useState<any>(null)

    const { importActivities, uploading } = useImportActivities((response: any) => {
    ...
    function downloadSample(e: any) {
        preventDefault(e);
        download('Sample Activities.xlsx', 'https://mafoi.s3.ap-south-1.amazonaws.com/bulkuploadtemplates/ActivitiesTemplate.xlsx')
    }
        ...
        <>
            <Modal show={true} backdrop="static" animation={false} size="lg" dialogClassName="" centered={true}>
                <Modal.Header closeButton={true} onHide={onClose}>
                    <Modal.Title className="bg">Import Activities</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
export default ActivitiesImportModal;