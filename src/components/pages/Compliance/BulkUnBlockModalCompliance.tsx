...
function BulkUnBlockModalCompliance({ selected = {}, onClose, onSubmit }: any) {
    const [newDueDate, setNewDueDate] = useState<any>(new Date());
    const { updateBulkComplianceSchedule, updating } = useBulkUpdateComplianceSchedule(({ key, value }: any) => {
    ...
    function submit() {
        ...
        updateBulkComplianceSchedule(payload)
    }
...
export default BulkUnBlockModalCompliance;