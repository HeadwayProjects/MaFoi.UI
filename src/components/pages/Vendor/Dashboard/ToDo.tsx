...
function Todo({ upcoming, selectedCompany, selectedAssociateCompany, selectedLocation }: any) {
        ...
        if (selectedCompany && selectedAssociateCompany && selectedLocation) {
            ...
            api.get(`/api/ToDo/GetToDoByPerformance?${request.join('&')}`).then(response => {
                if (response && response.data) {
                    ...
                    setLabel(label);
                    setDateRange({ fromDate: data.startDate, toDate: data.endDate });
        ...
        <>
            <div className="card todo-card shadow">
                ...
                <div className="card-body pt-1">
                    ...
                    {
                        tabs &&
                        <NavTabs list={tabs} onTabChange={(tab: string) => setFrequency(tab)} />
                    }
