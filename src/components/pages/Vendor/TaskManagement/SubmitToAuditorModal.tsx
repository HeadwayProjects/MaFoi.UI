...
function SubmitToAuditorModal({ onClose, onSubmit, selectedRows }: any) {
        ...
        <Modal.Body>
          <div className="row mb-4">
            <div className="col-12">
              <p>There are <strong>{selectedRows.length} {selectedRows.length > 1 ? 'activities' : 'activity'}</strong> available for submission.</p>
              ...
              <p>Upon submission to Auditor, you will not be able to edit them further</p>
