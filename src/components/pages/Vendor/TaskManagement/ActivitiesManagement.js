...
function ActivitiesManagement() {
    ...
    function reactFormatter(JSX, JSXElementConstructor) {
    ...
    function ActionColumnElements({ cell }) {
        ...
        return (
            <div className="d-flex flex-row align-items-center justify-content-center">
                <span className="me-1" style={{ zoom: 1.6, opacity: 0.5, cursor: "pointer" }} onClick={() => downloadForm(row)} title="Download">
                ...
                {
                    readOnly ?
                        <span className="ms-1" style={{ zoom: 1.6, opacity: 0.5, cursor: "pointer" }} onClick={() => editActivity(row)} title="View">
                        ...
                        :
                        <span className="ms-1" style={{ zoom: 1.6, opacity: 0.5, cursor: "pointer" }} onClick={() => editActivity(row)} title="Edit">
                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const columns = [
        ...
        { title: "Action", hozAlign: "center", formatter: reactFormatter(<ActionColumnElements />) }
    ]
                                    ...
                                    <tr key={item.id}>
                                        ...
                                        <td>
                                            <div className="d-flex flex-row align-items-center">
                                                ...
                                                {
                                                    readOnly ?
                                                        <span className="ms-1" style={{ zoom: 1.6, opacity: 0.5, cursor: "pointer" }} onClick={() => editActivity(item)} title="View">
