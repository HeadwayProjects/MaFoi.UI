            ...
            <>
                <Modal show={true} backdrop="static" animation={false} size="lg">
                    <Modal.Header closeButton={true} onHide={this.handleClose.bind(this)}>
                        <Modal.Title className="bg">{this.state.allowEdit ? 'Edit Activity' : 'Activity Details'}</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                                                        ...
                                                        <td width="25%">
                                                            <div className="d-flex flex-row align-items-center">
                                                                ...
                                                                <span className="me-4" style={{ zoom: 1.6, opacity: 0.5, cursor: "pointer" }}
                                                                    onClick={() => file.download(file)} title="Download">
                                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                {
                                                                    this.state.allowEdit &&
                                                                    <span style={{ opacity: 0.5, cursor: "pointer", color: "var(--red)" }} onClick={() => file.delete(file)}
                                                                        title="Delete">
