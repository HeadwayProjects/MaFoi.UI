...
import UnBlockComplianceModal from "./UnBlockComplianceModal";
import BulkUnBlockModalCompliance from "./BulkUnBlockModalCompliance";
    ...
    return (
        <>
            ...
            }
            {
                ...
                <UnBlockComplianceModal activity={activity} onSubmit={refetch} onClose={dismissAction} />
            }
            {
                action === ACTIONS.BULK_EDIT && (selectedRows || []).length > 0 &&
                <BulkUnBlockModalCompliance selected={selectedRows} onSubmit={refetch} onClose={dismissAction} />
            }
        </>
    );
...
export default LockUnLockCompliance;