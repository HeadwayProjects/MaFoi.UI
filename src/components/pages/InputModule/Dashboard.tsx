...
console.log('formResonseUrl',formResponseUrl);
     ...
     // alert('filedownloadresponseURL : ' +filedownloadresponseURL);
      ...
      // alert(fileRef);
       ...
       const fileDownloadResponse = await axios.get('https://ezycomp.buoyantworx.com/app/rest/files', {
        headers: {
          'Authorization': `Bearer ${accessToken}`
        },
        params: {
  ...
  const handleProcessRegisters2=async ()=>{
    ...
    if(stateName == '912da48d-630f-4cdb-9b24-d27cda14fc03'){
      fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_TN_Reporting_Controller/getAllTamilNaduForms';
    }
    else if(stateName == '59b24896-1f55-4037-b631-c699dd9fd2bc')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Reporting_Controller/getAllKarnatakaForms';
    }
    else if(stateName == '827e4dd8-079e-4c4f-a7ef-783c52926226')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/BWS_AP_Controller/getAllAndraPradeshForms';
    }
    else if(stateName == '75144ed9-1a78-4a0d-8d69-6519a9908dc3')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/BWS_Telangana_Controller/getAllTelanganaForms';
    }
    else if(stateName == '6ece4005-dff4-471b-aade-8139bba6b5e2')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Kerala_Controller/getAllKeralaForms';
    }
    else if(stateName == 'bcc02dfd-dc75-46f0-9097-9645be70c457')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Maharastra_Controller/getAllMaharastraForms';
    }
    else if(stateName == '334b472a-fbc6-40a5-a7a6-0960fd89fab8')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Rajastan_Controller/getAllRajastanForms';
    }
    else if(stateName == '958d51e8-9dda-47cf-a537-1b471026b0c6')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Gujarath_Controller/getAllGujarathForms';
    }
    else if(stateName == '3995e3f5-718c-420b-8fc3-636362b0f592')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Punjab_Controller/getAllPunjabForms';
    }
    else if(stateName == '2bce7366-0e00-4f25-889c-46e583920dc4')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_MadhyaPradesh_Controller/getAllMadhyaPradeshForms';
    }
    else if(stateName == 'f1ebf4e0-4060-493c-b632-af8895082ac5')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Chattisgarh_Controller/getAllChattisgarhForms';
    }
    else if(stateName == 'e74e0987-b17a-4ea8-a90c-c83545a84083')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Chandigarh_Controller/getAllChandigarhForms';
    }
    else if(stateName == '635d88d7-b89e-4a40-9e4c-569c6ea2a5c0')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Haryana_Controller/getAllHaryanaForms';
    }
    else if(stateName == 'b4d010ce-1b8c-4547-bfee-e9fddde05ce4')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Delhi_Controller/getAllDelhiForms';
    }
    else if(stateName == '7d710181-1a02-4d56-923c-0ba4b5b9f59f')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_UttarPradesh_Controller/getAllUttarPradeshForms';
    }
    else if(stateName == '0d8f1621-29d5-4141-9c7e-3e93084d05b5')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Goa_Controller/getAllGoaForms';
    }
    else if(stateName == '3e163775-c0b8-48f0-9097-f32eb50b0f55')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_PondiCherry_Controller/getAllPondiCherryForms';
    }
    else if(stateName == '12d45b68-0ed1-40ff-b268-bd30a814d484')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Bihar_Controller/getAllBiharForms';
    }
    else if(stateName == '97c92fbd-40b0-4d11-8557-8ded6d0a06ab')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Assam_Controller/getAllAssamForms';
    }
    else if(stateName == '5bcd6f97-3065-4f62-9a02-17236ad9abe5')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_Odisha_Controller/getAllOdishaForms';
    }
    else if(stateName == 'aff2d7e5-8619-4887-9865-df2164606b0f')
      {
        fileUrl = 'https://ezycomp.buoyantworx.com/app/rest/services/bws_WestBengal_Controller/getAllWestBengalForms';
    }
    else{
...
const newBaseURL = "https://ezycomp.buoyantworx.com/app/rest/";
...
{
                  //     hasUserAccess(USER_PRIVILEGES.REGISTER_GENERATION_DASHBOARD) &&
