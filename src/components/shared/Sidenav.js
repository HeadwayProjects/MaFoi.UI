                ...
                user !== null ?
                    <ul className='sideNav m-0 p-0'>
                        ...
                        </li>
                        {
                            !isVendor &&
                            <>
                                <li><NavItem url="/dashboard">Dashboard</NavItem></li>
                                <li><NavItem url="/manage-users">Manage Users</NavItem></li>
                                <li><NavItem url="/input-module">Input Module</NavItem></li>
                            </>
                        }
                        ...
                        </li>
                        {
                            !isVendor &&
                            <>
                                <li><NavItem url="/reports">reports</NavItem></li>
                            </>
                        }
                    </ul> : null
